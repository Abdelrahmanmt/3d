    ...
    var o = function(t, o, a, i) {
      ...
      , n = function(t, e, n, r, s, l, d, h, f) {
        ...
        if (12 == t || 13 == t || 14 == t || 15 == t) {
            ...
            f.add(punchgs.TweenLite.set(it, {
                left: 0,
                top: 0,
                scale: 1,
                opacity: 1,
        ...
        if (21 == t || 25 == t) {
            ...
            1 != g ? (wt = -r.width,
            ut = 90,
            25 == t ? (gt = "center top 0",
            vt = -ut,
            ut = r.rotate) : (gt = "left center 0",
            vt = r.rotate)) : (wt = r.width,
            ut = -90,
            25 == t ? (gt = "center bottom 0",
            vt = -ut,
            ut = r.rotate) : (gt = "right center 0",
            vt = r.rotate)),
            h.find(".slotslide").each(function(t) {
                var e = jQuery(this);
                f.add(punchgs.TweenLite.fromTo(e, y / 1e3, {
